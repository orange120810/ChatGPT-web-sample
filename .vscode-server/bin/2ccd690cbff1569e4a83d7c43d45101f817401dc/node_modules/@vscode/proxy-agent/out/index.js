...
function patchTlsConnect(params, original) {
    function connect(...args) {
        ...
        if (!params.useSystemCertificatesV2 || (options === null || options === void 0 ? void 0 : options.ca)) {
            return original.apply(null, arguments);
        }
...
function patchCreateSecureContext(original) {
    return function (details) {
        ...
        const certs = (_a = details) === null || _a === void 0 ? void 0 : _a._vscodeAdditionalCaCerts;
        if (certs) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (!_caCertificates) {
            _caCertificates = readCaCertificates()
                ...
                _caCertificateValues = ((res === null || res === void 0 ? void 0 : res.certs) || []).concat(params.addCertificates);
